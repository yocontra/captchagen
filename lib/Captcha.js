...
var speak = require('espeak').speak;
...
Captcha.prototype.audio = function(cb) {
  var args = ['-s 90', '-g 20', '-p 50'];
  var textSpaced = this.options.text.replace(/\w/g, '$& ');
  return speak(textSpaced, args, cb);
};
